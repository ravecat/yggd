      ...
      : FieldSelection[FieldIndex] extends Record<string, any>
        ? {
            [UnionKey in keyof FieldSelection[FieldIndex]]: UnionKey extends keyof UnionSchema
              ? NonNullable<UnionSchema[UnionKey]> extends {
                  __array: true;
                  __type: "TypedMap";
                      ...
                      UnionToIntersection<
                        {
                          [FieldIdx in keyof FieldSelection[FieldIndex][UnionKey]]: FieldSelection[FieldIndex][UnionKey][FieldIdx] extends TypedMapFields
                            ? FieldSelection[FieldIndex][UnionKey][FieldIdx] extends keyof NonNullable<
                                UnionSchema[UnionKey]
                              >
                              ? {
                                  [P in FieldSelection[FieldIndex][UnionKey][FieldIdx]]: NonNullable<
                                    UnionSchema[UnionKey]
                                  >[P];
                                }
                              : never
                ...
                : NonNullable<UnionSchema[UnionKey]> extends {
                  ...
                  : NonNullable<UnionSchema[UnionKey]> extends TypedSchema
                    ? InferResult<
                        NonNullable<UnionSchema[UnionKey]>,
          ...
          ? T[K] extends { __array: true }
            ? (
                ...
                | {
                    ...
                    >]?: NonNullable<T[K][UnionKey]> extends {
                      __type: "TypedMap";
            ...
            : (
                | PrimitiveFields
                | {
                    [UnionKey in keyof Omit<T[K], "__type" | "__primitiveFields">]?: NonNullable<
                      T[K][UnionKey]
                    > extends { __type: "TypedMap"; __primitiveFields: any }
                      ? NonNullable<T[K][UnionKey]>["__primitiveFields"][]
                      : NonNullable<T[K][UnionKey]> extends TypedSchema
                        ? UnifiedFieldSelection<NonNullable<T[K][UnionKey]>>[]
                        : never;
...
export type InferFieldValue<T extends TypedSchema, Field> = Field extends T["__primitiveFields"]
                                        ...
                                        >
                                          ? NonNullable<
                                            ...
                                            ? null extends NonNullable<T[K]>[NestedKey]
                                              ? InferResult<
                                                  NonNullable<NonNullable<T[K]>[NestedKey]>,
                                                  E[NestedKey]
                                                > | null
                                              : InferResult<
                                                  NonNullable<NonNullable<T[K]>[NestedKey]>,
...
export type HasPaginationParams<Page> = Page extends { offset: any }
  ? true
...
export type InferPaginationType<Page> = Page extends { offset: any }
  ? "offset"
...
export type ConditionalPaginatedResult<Page, RecordType, PaginatedType> = Page extends undefined
  ? RecordType
...
export type ConditionalPaginatedResultMixed<Page, RecordType, OffsetType, KeysetType> =
 ...
 * };
 */
export type ValidationResult = { success: true } | { success: false; errors: AshRpcError[] };
...
export type InferGetByEmailResult<Fields extends GetByEmailFields> = InferResult<
  UserResourceSchema,
  Fields
>;

export type GetByEmailResult<Fields extends GetByEmailFields> =
  | { success: true; data: InferGetByEmailResult<Fields> }
 ...
 * @ashActionType :read
 */
export async function getByEmail<Fields extends GetByEmailFields>(config: {
  tenant?: string;
  ...
  return executeActionRpcRequest<GetByEmailResult<Fields>>(payload, config);
}
 ...
 * @validation true
 */
export async function validateGetByEmail(config: {
  tenant?: string;
  input: GetByEmailInput;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  ...
  return executeValidationRpcRequest<ValidationResult>(payload, config);
}
...
>(config: Config & { fields: Fields }): Promise<ListUsersResult<Fields, Config["page"]>> {
  const payload = {
    action: "list_users",
    ...(config.tenant !== undefined && { tenant: config.tenant }),
    ...(config.fields !== undefined && { fields: config.fields }),
  ...
  return executeActionRpcRequest<ListUsersResult<Fields, Config["page"]>>(payload, config);
}
...
export type InferListTodosResult<Fields extends ListTodosFields> =
  | {
...
export type ListTodosResult<Fields extends ListTodosFields> =
  | { success: true; data: InferListTodosResult<Fields> }
  | { success: false; errors: AshRpcError[] };
 ...
 * @ashActionType :read
 */
export async function listTodos<Fields extends ListTodosFields>(config: {
  tenant?: string;
  fields: Fields;
  ...
  return executeActionRpcRequest<ListTodosResult<Fields>>(payload, config);
}
 ...
 * @validation true
 */
export async function validateListTodos(config: {
  tenant?: string;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
  customFetch?: (input: RequestInfo | URL, init?: RequestInit) => Promise<Response>;
...
export type InferCreateTodoResult<Fields extends CreateTodoFields | undefined> = InferResult<
  TodoResourceSchema,
  Fields
>;

export type CreateTodoResult<Fields extends CreateTodoFields | undefined = undefined> =
  | { success: true; data: InferCreateTodoResult<Fields> }
  | { success: false; errors: AshRpcError[] };
 ...
 */
export async function createTodo<Fields extends CreateTodoFields | undefined = undefined>(config: {
  tenant?: string;
 ...
 * @validation true
 */
export async function validateCreateTodo(config: {
  tenant?: string;
  input: CreateTodoInput;
  headers?: Record<string, string>;
  fetchOptions?: RequestInit;
...
export type InferUpdateTodoResult<Fields extends UpdateTodoFields | undefined> = InferResult<
  TodoResourceSchema,
  Fields
>;

export type UpdateTodoResult<Fields extends UpdateTodoFields | undefined = undefined> =
  | { success: true; data: InferUpdateTodoResult<Fields> }
  | { success: false; errors: AshRpcError[] };
 ...
 */
export async function updateTodo<Fields extends UpdateTodoFields | undefined = undefined>(config: {
  tenant?: string;
  identity: UUID;
 ...
 * @validation true
 */
export async function validateUpdateTodo(config: {
  tenant?: string;
