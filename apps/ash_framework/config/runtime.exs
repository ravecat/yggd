...
#
#     PHX_SERVER=true bin/ash_framework start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :ash_framework, AshFrameworkWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :ash_framework, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :ash_framework, AshFramework.Mailer,
