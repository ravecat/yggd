...
config :ash_framework, AshFrameworkWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/ash_framework_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :ash_framework, dev_routes: true, token_signing_secret: "MfFey7vLAONsdSzoD0/8F+/jSLzJoSPj"
