...
export const telemetryMetricPoint = z
  .object({
    name: z
      .string()
      .describe("Metric name used for chart routing and widget identity."),
    unit: z
      .string()
      .describe(
    ...
    tsUnixSec: z
      .number()
      .describe("Unix timestamp in seconds as a JS-safe numeric value."),
    series: z
      .array(
        z.object({
          ...
          value: z
            .number()
            .describe("Numeric value for the series at tsUnixSec."),
        }),
      )
      .min(1),
  })
