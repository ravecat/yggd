...
export const patchTodosIdQueryParamsSchema = z.object({
 ...
 */
export const patchTodosIdErrorSchema = errorsSchema
...
export const patchTodosIdMutationResponseSchema = patchTodosId200Schema