...
export const todoFilterSchema = z.object({
    get and(){
                return z.array(todoFilterSchema.describe("Filters the query to results matching the given filter object")).refine(items => new Set(items).size === items.length, { message: "Array entries must be unique" }).optional()
              },
get content(){
